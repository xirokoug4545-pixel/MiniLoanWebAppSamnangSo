    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <div class="mb-4">
                ...
                <p class="h3 mb-0">${{ number_format($outstandingAmount, 2) }}</p>
            </div>
            ...
            <form action="{{ route('repayments.store', $schedule->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        min="0.01"
                        step="0.01"
                        value="{{ old('amount_paid', $outstandingAmount) }}"
                        required
                    >
                    <div class="form-text">Partial payments are allowed. Extra payment is applied to later installments.</div>
                </div>
